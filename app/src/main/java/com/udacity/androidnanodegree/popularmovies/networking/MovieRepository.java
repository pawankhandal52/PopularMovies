...
public class MovieRepository {
    ...
    //Make initialize the variable so we can call other member of this class directly using instance
    ...
    public LiveData<Response<MovieTrailers>> getMoviesTrailersFromTMDBServer(String movieId){
        ...
        reviewsCall.enqueue(new Callback<MovieTrailers>() {
            ...
            @Override
            public void onFailure(@NonNull Call<MovieTrailers> call, Throwable t) {
